...
export default function About() {
               ...
               <div class="about-conent paragraph">
                  ...
                  <div class="row justify-content-between mt20">
                     <div class="col-lg-6">
                        ...
                        <p>With the experience of over 4 years in the industry and over 1000+ devices repaired, Our team use only the highest quality parts for all repairs, and each job is covered by our comprehensive warranty.
                     ...
                     <div class="col-lg-6">
                        ...
                        <p>We include a doorstep repair service which implies you don’t need to stress over making a special effort to drop the phone off. Rather we repair your device at your home on time convenient for you.
            ...
            <div class="col-lg-7">
               <div class="about-conent paragraph">
                  ...
                  <div class="item-pair mt40 wow fadeIn" data-wow-delay=".6s" data-wow-duration="1500ms">
                     <Link href="Repairmydevice" class="sw-btn sw-blue-btn">Book Now</Link>
   ...
   <section class="aboutblock section-space bkbg3">
      <div class="container">
         <div class="row v-center">
            <div class="col-lg-7">
               <div class="about-conent paragraph">
